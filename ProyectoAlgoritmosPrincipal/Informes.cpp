...
void Informes::initComponents() {
    ...
    this->btnTotalAviones.signal_clicked().connect(sigc::mem_fun(*this,
            &Informes::onButtonClickedAviones));
...
void Informes::onButtonClickedIngresar() {
...
void Informes::onButtonClickedAviones() {
