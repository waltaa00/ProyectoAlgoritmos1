...
${OBJECTDIR}/EliminarVuelo.o: EliminarVuelo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EliminarVuelo.o EliminarVuelo.cpp
...
${OBJECTDIR}/ModuloAdministrativo.o: ModuloAdministrativo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuloAdministrativo.o ModuloAdministrativo.cpp
...
${OBJECTDIR}/MuestraSalidas.o: MuestraSalidas.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MuestraSalidas.o MuestraSalidas.cpp
